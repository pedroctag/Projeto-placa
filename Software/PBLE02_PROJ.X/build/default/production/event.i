...
static unsigned char protocolo[32];
...
# 105 "event.c"
                ...
                if((protocolo[6] == 'L' || protocolo[6] == 'l') && (protocolo[7] == 'V' || protocolo[7] == 'v')){
                    for(int i = 9; i <= protocolo_index; i++){
                        ...
                        if (protocolo[i]>= '0' && protocolo[i] <= '9') {
                            ...
                            serialString("Error: invalid prompt value");
                            return;
                        } }
                    if(new_value != 0){
                        if(new_value > 100){
    ...
    if(err == 1){
        serialString("protocolo invalido | invalid protocol");
    }
}
